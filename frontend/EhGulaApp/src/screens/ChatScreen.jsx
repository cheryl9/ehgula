  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        {/* Alert banner when agent flags urgent */}
        {alertLevel === 'urgent' && (
          <View style={styles.alertBanner}>
            <Text style={styles.alertText}>
              Health alert — please check the message below
            </Text>
          </View>
        )}
        ...
        {pendingBooking && (
          <View style={styles.bookingBanner}>
            <Text style={styles.bookingText}>
              Appointment pending — reply yes or no in chat
            </Text>
          </View>
        )}
        ...
        >
          ...
          {/* AgentThinking — plays animation, then fires real API call */}
          {isThinking && (
            <AgentThinking
              steps={thinkingSteps}
          ...
          {/* Spinner while waiting for backend reply after animation */}
          ...
          <View style={styles.inputBox}>
            ...
            <View style={styles.inputActions}>
              ...
              <TouchableOpacity
                ...
                onPress={() => handleSend()}
                disabled={!input.trim() || chatThinking || isThinking}
              >
...
const styles = StyleSheet.create({
  ...
  errorText:             { color: '#CC0000', fontSize: 12, padding: 8, textAlign: 'center' },
